...
class Game:
    ...
    def show_game_over(self):
        ...
        font = pygame.font.SysFont('arial', 30)
        line1 = font.render(
            f"Game is over! Your score is {self.snake.length}", True, (200, 200, 200))
        self.surface.blit(line1, (200, 300))
        line2 = font.render(
            "To play game again press Enter. To exit press Escape!", True, (200, 200, 200))
